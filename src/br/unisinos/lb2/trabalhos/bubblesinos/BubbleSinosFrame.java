...
public class BubbleSinosFrame extends javax.swing.JFrame {
	...
	private void initComponents() {
		...
		org.jdesktop.layout.GroupLayout bubbleSinosPanel1Layout = new org.jdesktop.layout.GroupLayout(
				bubbleSinosPanel1);
		bubbleSinosPanel1.setLayout(bubbleSinosPanel1Layout);
		bubbleSinosPanel1Layout.setHorizontalGroup(bubbleSinosPanel1Layout
				.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING).add(0, 400, Short.MAX_VALUE));
		bubbleSinosPanel1Layout.setVerticalGroup(bubbleSinosPanel1Layout
				.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING).add(0, 260, Short.MAX_VALUE));
	...
	public static void main(String args[]) {
		...
		try {
			...
			java.util.logging.Logger.getLogger(BubbleSinosFrame.class.getName()).log(java.util.logging.Level.SEVERE,
					null, ex);
	...
	private void play() {
		...
		// TODO: Fazer tratamento de erro, caso não consiga converter para um
		// número
		int col = 0;
		try {
		...
		if (col >= matrix.getLargura() || col < 0) {
			...
			try {
				...
				elemento = sorteiaProximoElemento();
				pnCor.setBackground(BubbleSinosPanel.getCorElemento(elemento));
				// se a soma da matriz der zero quer dizer que o cara venceu o
				// jogo
	...
	private void fimDeJogo(String msgm) {
		// TODO: detectar fim do jogo e reiniciar o jogo, se for o caso, ou
		// sair.
	...
	private int sorteiaProximoElemento() {
		// DONE: sortear um número aleartório entre
		// [1..BubbleSinosPanel.NUM_CORES].
